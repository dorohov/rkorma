...
$(".page-loader .close-loader").on("click",function(e){e.preventDefault(),$(".page-loader").removeClass("active")}),$(document.body).on("click.fecss","div.page-loader.full-screen.rkorma-style.active .blind",function(e){e.preventDefault(),$("div.page-loader.full-screen.rkorma-style").data("window-can-close-it",!0).data("counter-can-close-it",!0).trigger("fecss.can-close-it")}),$(document.body).on("fecss.can-close-it","div.page-loader.full-screen.rkorma-style",function(e){e.preventDefault(),$(this).data("counter-can-close-it")&&$(this).data("window-can-close-it")&&$(this).removeClass("active")}),$(window).load(function(e){e.preventDefault(),$("div.page-loader.full-screen.rkorma-style").data("window-can-close-it",!0).trigger("fecss.can-close-it"),$("div.page-loader.full-screen.rkorma-style .blind").data("fast-page-loading",!0)});
